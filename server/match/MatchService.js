class MatchService {
    constructor({ pool, WebSocketClass }) {
        ...
        this.MATCH_BROADCAST_EVERY_FRAMES_LOW_LOAD = 2;
        this.MATCH_BROADCAST_EVERY_FRAMES = 4;
        this.MATCH_BROADCAST_EVERY_FRAMES_HIGH_LOAD = 6;
        this.MATCH_BROADCAST_EVERY_FRAMES_VERY_HIGH_LOAD = 8;
        ...
        this.SERVER_FORMATION_LANE_OFFSETS = [-45, -35, -25, -15, -5, 5, 15, 25, 35, 45];
        this.SERVER_MARCH_STEER_INTERVAL = 10;
        this.SERVER_MARCH_STEER_STEP = 12;
        this.SERVER_MARCH_STEER_LIMIT = 64;
    ...
    getBroadcastEveryFrames(sim) {
        ...
        if (unitCount >= 70)
            return this.MATCH_BROADCAST_EVERY_FRAMES_VERY_HIGH_LOAD;
        if (unitCount >= 40)
            return this.MATCH_BROADCAST_EVERY_FRAMES_HIGH_LOAD;
        if (unitCount <= 16)
            return this.MATCH_BROADCAST_EVERY_FRAMES_LOW_LOAD;
